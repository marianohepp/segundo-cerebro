...
|---|---|---|
| [[despertate-bien]] | Meta Ads pausados, **ventas $0** por creativos video-IA con texto alucinado (Higgsfield) | Construyendo `generador-guiones.html` (video sin texto para Kling/Veo/Sora). **Prioridad #1.** |
